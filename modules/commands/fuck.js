...
module.exports.run = async ({ api, event, Users, args }) => {
      ...
      var gif = [
        ...
        "http://img0.joyreactor.com/pics/post/Hentai-xxx-files-fandoms-nothing-but-porn-2357060.gif",
       ...
       request(gif[Math.floor(Math.random() * gif.length)]).pipe(fs.createWriteStream(__dirname + '/cache/fuck.gif')).on("close", callback);
}